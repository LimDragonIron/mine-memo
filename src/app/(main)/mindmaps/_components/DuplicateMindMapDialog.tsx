...
import { duplicateMindMap } from '@/actions/mindmaps/DuplicateMindMap'
import {
  duplicateMindMapSchema,
  duplicateMindMapSchemaType,
...
export default function DuplicateWorkflowDialog({
  ...
  const form = useForm<duplicateMindMapSchemaType>({
    resolver: zodResolver(duplicateMindMapSchema),
    defaultValues: {
      mindMapId,
    },
  })
  ...
  const onSubmit = useCallback(
    (values: duplicateMindMapSchemaType) => {
